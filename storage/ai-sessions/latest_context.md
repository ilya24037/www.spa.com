...
Дата генерации: 03.07.2025 10:44:22
...
- 📄 Страница resources/js\Pages\AddItem\Index.vue (изменён в 10:42)
- 📄 Страница resources/js\Pages\Dashboard архив.vue (изменён в 10:29)
- 🧩 Компонент resources/js\Components\Footer\Footer.vue (изменён в 10:29)
- 🧩 Компонент resources/js\Components\Header\MobileMenu.vue (изменён в 10:28)
- 🧩 Компонент resources/js\Components\Header\Navbar.vue (изменён в 10:28)
- 🧩 Компонент resources/js\Components\Header\UserMenu.vue (изменён в 10:28)
- 📄 Страница resources/js\Pages\Dashboard.vue (изменён в 10:28)
- 🎮 Контроллер app\Http\Controllers\AddItemController.php (изменён в 08:41)
- 📄 Страница resources/js\Pages\Bookings\Index.vue (изменён в 16:53)
- 📄 Страница resources/js\Pages\Favorites\Index.vue (изменён в 16:49)
...
*Этот контекст автоматически сгенерирован 03.07.2025 в 10:44*