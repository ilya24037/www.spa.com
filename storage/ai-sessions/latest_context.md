...
Дата генерации: 03.07.2025 13:55:00
...
- 📄 Страница resources/js\Pages\Masters\Show.vue (изменён в 13:50)
- 🎮 Контроллер app\Http\Controllers\MasterController.php (изменён в 13:46)
- 🧩 Компонент resources/js\Components\MetaTags.vue (изменён в 13:44)
- 📁 Файл app\Console\Commands\GenerateMasterMetaTags.php (изменён в 12:54)
- 📋 Модель app\Models\MasterProfile.php (изменён в 12:52)
...
- 📁 Файл app\Traits\HasUniqueSlug.php (изменён в 12:30)
- 🎮 Контроллер app\Http\Controllers\AddItemController.php (изменён в 11:55)
- 📄 Страница resources/js\Pages\AddItem\Massage.vue (изменён в 11:47)
...
*Этот контекст автоматически сгенерирован 03.07.2025 в 13:55*