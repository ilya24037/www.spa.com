...
Дата генерации: 15.06.2025 21:50:45
...
- 📄 Страница resources/js\Pages\Auth\Login.vue (изменён в 21:50)
- 📄 Страница resources/js\Pages\Auth\Register.vue (изменён в 21:50)
- 📄 Страница resources/js\Pages\Auth\ResetPassword.vue (изменён в 21:50)
- 📄 Страница resources/js\Pages\Auth\VerifyEmail.vue (изменён в 21:50)
- 📄 Страница resources/js\Pages\Bookings\Index.vue (изменён в 21:50)

🎯 **Скорее всего работали над:** страницами и роутингом

**⚠️ Незакоммиченные изменения:** 17 файлов
...
*Этот контекст автоматически сгенерирован 15.06.2025 в 21:50*