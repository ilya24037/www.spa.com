...
Дата генерации: 01.07.2025 12:04:21
...
- 📄 Страница resources/js\Pages\архив Dashboard.vue (изменён в 11:54)
- 🎮 Контроллер app\Http\Controllers\ProfileController.php (изменён в 10:23)
- 📋 Модель app\Models\MassageCategory.php (изменён в 09:59)
- ⚡ JavaScript resources/js\app.js (изменён в 09:54)
- ⚡ JavaScript resources/js\ziggy.js (изменён в 09:40)
- 📋 Модель app\Models\MasterProfile.php (изменён в 08:54)
- 🗄️ Миграция database\migrations\2025_07_01_084127_create_master_photos_table.php (изменён в 08:41)
- 📋 Модель app\Models\MasterPhoto.php (изменён в 08:40)
- 🎮 Контроллер app\Http\Controllers\MasterController.php (изменён в 08:35)
- 🗄️ Миграция database\migrations\2025_07_01_081421_create_favorites_table.php (изменён в 08:16)

🎯 **Скорее всего работали над:** структурой данных и моделями

**⚠️ Незакоммиченные изменения:** 13 файлов
...
*Этот контекст автоматически сгенерирован 01.07.2025 в 12:04*