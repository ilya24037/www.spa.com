...
Дата генерации: 16.06.2025 12:44:08
...
- 🧩 Компонент resources/js\Components\Header\CompareButton.vue (изменён в 12:43)
- 🧩 Компонент resources/js\Components\Header\FavoritesButton.vue (изменён в 12:42)
- 🧩 Компонент resources/js\Components\Header\QuickLinks.vue (изменён в 12:41)
- 🧩 Компонент resources/js\Components\Header\Navbar.vue (изменён в 12:41)
- 🧩 Компонент resources/js\Components\Header\CitySelector.vue (изменён в 12:41)
- 🧩 Компонент resources/js\Components\Header\SearchBar.vue (изменён в 12:40)
- 🧩 Компонент resources/js\Components\Header\CityModal.vue (изменён в 12:35)
- 🧩 Компонент resources/js\Components\Header\CatalogDropdown.vue (изменён в 12:32)
- 🧩 Компонент resources/js\Components\Header\Logo.vue (изменён в 12:23)
...
*Этот контекст автоматически сгенерирован 16.06.2025 в 12:44*