...
Дата генерации: 16.06.2025 19:13:40
...
- 🧩 Компонент resources/js\Components\Filters\FiltersSidebar.vue (изменён в 19:09)
...
*Этот контекст автоматически сгенерирован 16.06.2025 в 19:13*