...
Дата генерации: 15.06.2025 23:27:47
...
- 🧩 Компонент resources/js\Components\Common\ViewSwitcher.vue (изменён в 23:20)
- ⚡ JavaScript resources/js\app.js (изменён в 23:19)
- 📄 Страница resources/js\Pages\Home.vue (изменён в 23:18)
- 🎨 Vue файл resources/js\Layouts\AppLayout.vue (изменён в 23:18)
- 🧩 Компонент resources/js\Components\Common\ErrorBoundary.vue (изменён в 23:17)
- 🧩 Компонент resources/js\Components\Header\Navbar.vue (изменён в 23:02)
- 🧩 Компонент resources/js\Components\Footer\Footer.vue (изменён в 22:55)
...
*Этот контекст автоматически сгенерирован 15.06.2025 в 23:27*