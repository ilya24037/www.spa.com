    ...
    async createBooking(bookingData) {
        try {
            ...
            const response = await axios.post('/api/bookings', {
                ...
                client_comment: bookingData.notes,
                service_location: 'salon', // TODO: получать из формы
                payment_method: 'cash' // TODO: получать из формы
            })
