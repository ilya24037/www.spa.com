<template>
  <div class="item-stats-section">
    ...
    <div v-if="item.status !== 'draft'" class="item-lifetime">
      <span v-if="item.status === 'waiting_payment'" class="lifetime-text text-gray-500">
    ...
    <div v-if="item.status === 'draft'" class="item-lifetime">
      <div class="draft-info">
        <div class="draft-status">
          РЈРґР°Р»РёС‚СЃСЏ РЅР°РІСЃРµРіРґР° С‡РµСЂРµР· 30 РґРЅРµР№
        </div>
      </div>
    </div>
    ...
    <div class="item-chats">
      ...
      >
        <path
          d="M2 3h12c.6 0 1 .4 1 1v6c0 .6-.4 1-1 1h-3l-3 2v-2H2c-.6 0-1-.4-1-1V4c0-.6.4-1 1-1z" 
          stroke="currentColor" 
          stroke-width="1" 
          fill="none"
        />
...
.lifetime-text {
  @apply text-gray-500 font-normal; /* Р§РµСЂРЅС‹Р№ С‚РµРєСЃС‚ РєР°Рє РЅР° СЃРєСЂРёРЅРµ */
}
