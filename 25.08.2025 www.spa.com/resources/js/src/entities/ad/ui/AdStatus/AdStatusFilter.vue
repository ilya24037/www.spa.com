...
const LABEL_CLASSES = 'block text-sm font-medium text-gray-500'
...
const BUTTON_INACTIVE_CLASSES = 'bg-white text-gray-500 border border-gray-500 hover:bg-gray-500'
const COUNT_CLASSES = 'text-xs bg-gray-500 text-gray-500 px-1.5 py-0.5 rounded-full min-w-[20px] text-center'
