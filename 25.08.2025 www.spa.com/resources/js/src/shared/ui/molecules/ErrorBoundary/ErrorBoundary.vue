  ...
  <div v-if="hasError" class="error-boundary">
    <div class="error-container">
      ...
      <p class="error-message">
        {{ errorMessage || 'Произошла непредвиденная ошибка при загрузке компонента.' }}
      </p>
...
.error-title {
  @apply text-2xl font-bold text-gray-500 mb-2;
}
...
.error-details-container {
  @apply text-left bg-gray-500 rounded-lg p-4;
}

.error-details-summary {
  @apply cursor-pointer text-sm font-medium text-gray-500 hover:text-gray-500;
}
...
.error-button-secondary {
  @apply bg-gray-500 text-gray-500 hover:bg-gray-500 focus:ring-gray-500;
}
</style>