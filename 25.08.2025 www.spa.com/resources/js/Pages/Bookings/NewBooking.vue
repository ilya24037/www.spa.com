  ...
  <div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav class="mb-6 text-sm">
        <Link :href="route('home')" class="text-gray-500 hover:text-gray-500">
          Р“Р»Р°РІРЅР°СЏ
        </Link>
      ...
      <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <h1 class="text-2xl font-bold mb-6">
            РћС„РѕСЂРјР»РµРЅРёРµ Р±СЂРѕРЅРёСЂРѕРІР°РЅРёСЏ
          </h1>
          ...
          <form class="space-y-6" @submit.prevent="submit">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
              <h2 class="text-lg font-semibold mb-4">
                Р“РґРµ Р±СѓРґРµС‚ РѕРєР°Р·Р°РЅР° СѓСЃР»СѓРіР°?
              </h2>
                            
              <div class="space-y-3">
                <label
                  class="flex items-start p-4 border rounded-lg cursor-pointer hover:bg-gray-500 transition"
                  :class="form.service_location === 'home' ? 'border-blue-500 bg-blue-50' : 'border-gray-500'"
                >
                  <input 
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-sm text-gray-500">РњР°СЃС‚РµСЂ РїСЂРёРµРґРµС‚ РїРѕ РІР°С€РµРјСѓ Р°РґСЂРµСЃСѓ</p>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
              ...
              <div class="space-y-2">
                <label
                  class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-500"
                  :class="form.payment_method === 'cash' ? 'border-blue-500 bg-blue-50' : 'border-gray-500'"
                >
                  <input 
                ...
                <label
                  class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-500"
                  :class="form.payment_method === 'card' ? 'border-blue-500 bg-blue-50' : 'border-gray-500'"
                >
                  <input 
                    v-model="form.payment_method" 
                    type="radio" 
                ...
                <label
                  class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-500"
                  :class="form.payment_method === 'online' ? 'border-blue-500 bg-blue-50' : 'border-gray-500'"
                >
                  <input 
                    v-model="form.payment_method" 
                    type="radio" 
                  ...
                  <span class="ml-auto text-xs bg-gray-500 px-2 py-1 rounded">РќРµРґРѕСЃС‚СѓРїРЅРѕ</span>
                </label>
              </div>
            </div>
