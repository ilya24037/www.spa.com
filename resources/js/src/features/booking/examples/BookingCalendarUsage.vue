<template>
  <div class="booking-calendar-examples p-8 space-y-8">
    <h1 class="text-2xl font-bold mb-8">
      Примеры использования BookingCalendar
    </h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
          <div class="bg-gray-500 p-4 rounded-lg">
            ...
            <pre class="text-xs text-gray-500">{{ JSON.stringify(calendarState, null, 2) }}</pre>
          </div>
    ...
    <div class="example-section">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <button class="btn btn-secondary" @click="selectRandomDate">
          Случайная дата
        </button>
      </div>
...
<style scoped>
.example-section {
  @apply pb-8 border-b border-gray-500 last:border-b-0;
}
