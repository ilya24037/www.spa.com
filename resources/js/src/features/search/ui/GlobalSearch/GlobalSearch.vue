...
<template>
  <div class="flex items-center flex-1 max-w-3xl">
    ...
    <div class="flex-1 relative">
      ...
      <button
        v-if="searchQuery"
        class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-500 transition-colors"
      ...
      >
        <div 
          ...
          class="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-500 rounded-b-lg shadow-lg z-50 max-h-96 overflow-y-auto"
        >
          ...
          <div v-else-if="suggestions.length > 0">
            <div class="p-2 text-xs font-medium text-gray-500 bg-gray-500 border-b">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <span v-if="suggestion.category" class="text-xs text-gray-500 group-hover:text-blue-600">
                  {{ suggestion.category }}
                </span>
              </div>
            </button>
...
const searchInputClasses = computed(() => [
    'w-full px-4 py-2.5 pr-10 border-y border-r-0 border-gray-500 text-gray-500 placeholder-gray-500',
    'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors',
    'disabled:bg-gray-500 disabled:text-gray-500'
])
