<!-- SkeletonStats.vue - Скелетон для статистики и дашборда -->
<template>
  <div 
    class="animate-pulse"
  ...
  >
    <!-- Заголовок секции -->
    <div class="h-6 bg-gray-200 rounded w-48 mb-6" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div class="h-8 bg-gray-200 rounded w-28 mb-2" />
    ...
    <div class="bg-white rounded-lg p-6 shadow-sm mb-8">
      ...
      <div class="flex justify-center gap-6">
        ...
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 bg-gray-200 rounded-full" />
          <div class="h-3 bg-gray-200 rounded w-18" />
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
      <div class="p-6 border-b border-gray-100">
        <div class="flex items-center justify-between">
          <div class="h-5 bg-gray-200 rounded w-36" />
          <div class="h-4 bg-gray-200 rounded w-20" />
        </div>
      </div>
      ...
      <div class="divide-y divide-gray-100">
        ...
        <div class="p-6 flex items-center gap-4">
          ...
          <div class="text-right">
            <div class="h-4 bg-gray-200 rounded w-16 mb-1" />
        ...
        <div class="p-6 flex items-center gap-4">
          ...
          <div class="text-right">
            <div class="h-4 bg-gray-200 rounded w-20 mb-1" />
        ...
        <div class="p-6 flex items-center gap-4">
          <div class="w-10 h-10 bg-gray-200 rounded-full flex-shrink-0" />
          <div class="flex-1">
            <div class="h-4 bg-gray-200 rounded w-4/5 mb-2" />
            <div class="h-3 bg-gray-200 rounded w-3/5" />
          </div>
          <div class="text-right">
            <div class="h-4 bg-gray-200 rounded w-18 mb-1" />
        ...
        <div class="p-6 flex items-center gap-4">
          <div class="w-10 h-10 bg-gray-200 rounded-full flex-shrink-0" />
          <div class="flex-1">
            <div class="h-4 bg-gray-200 rounded w-3/5 mb-2" />
...
// Компонент скелетона для статистики не требует логики
</script>
...
.animate-pulse .grid > div:nth-child(1) {
  animation-delay: 0s;
}

.animate-pulse .grid > div:nth-child(2) {
  animation-delay: 0.1s;
}

.animate-pulse .grid > div:nth-child(3) {
  animation-delay: 0.2s;
}

.animate-pulse .grid > div:nth-child(4) {
  animation-delay: 0.3s;
}

/* Анимация для элементов списка */
.animate-pulse .divide-y > div:nth-child(1n) {
  animation-delay: 0.4s;
}

.animate-pulse .divide-y > div:nth-child(2n) {
  animation-delay: 0.5s;
}

.animate-pulse .divide-y > div:nth-child(3n) {
  animation-delay: 0.6s;
}

.animate-pulse .divide-y > div:nth-child(4n) {
