<template>
  <Modal :show="show" :max-width="maxWidth" :variant="variant" @close="handleCancel">
    <div class="p-6">
      <!-- Р—Р°РіРѕР»РѕРІРѕРє -->
      ...
      <div class="flex justify-end space-x-3">
        <button
          type="button"
          class="px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-500 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          @click="handleCancel"
        >
          {{ cancelText }}
        </button>
...
const props = defineProps({
    ...
    title: {
        type: String,
        default: 'РџРѕРґС‚РІРµСЂР¶РґРµРЅРёРµ'
    },
    message: {
        type: String,
        default: 'Р’С‹ СѓРІРµСЂРµРЅС‹?'
    },
    confirmText: {
        type: String,
        default: 'РџРѕРґС‚РІРµСЂРґРёС‚СЊ'
    },
    cancelText: {
        type: String,
        default: 'РћС‚РјРµРЅР°'
