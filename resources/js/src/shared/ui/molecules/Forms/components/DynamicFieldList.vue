  ...
  <div class="dynamic-field-list">
    ...
    <div class="dynamic-field-header">
      <div class="dynamic-field-title-wrapper">
        <h4 v-if="label" class="dynamic-field-label">{{ label }}</h4>
    ...
    <p v-if="description" class="dynamic-field-description">{{ description }}</p>
    ...
    >
      ...
      <p class="dynamic-field-empty-text">{{ emptyStateText }}</p>
      <button
        type="button"
        :disabled="disabled"
...
/* РџСѓСЃС‚РѕРµ СЃРѕСЃС‚РѕСЏРЅРёРµ */
.dynamic-field-empty {
  @apply text-center py-8 px-4 bg-gray-50 border border-gray-200 border-dashed rounded-lg;
}
...
.dynamic-field-action-btn {
  @apply p-1 text-gray-400 hover:text-gray-600 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed;
}
