...
<template>
  <div class="booking-actions space-y-3">
    ...
    <button 
      v-if="!hasMessengers"
      class="w-full border border-gray-500 text-gray-500 py-2.5 px-4 rounded-lg font-medium hover:bg-gray-500 transition-colors flex items-center justify-center gap-2"
