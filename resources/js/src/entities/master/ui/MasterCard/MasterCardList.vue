  ...
  <div>
    ...
    >
      ...
      <p :class="EMPTY_SUBTITLE_CLASSES">
        РџРѕРїСЂРѕР±СѓР№С‚Рµ РёР·РјРµРЅРёС‚СЊ РїР°СЂР°РјРµС‚СЂС‹ РїРѕРёСЃРєР°
      </p>
    </div>
  </div>
</template>
...
const EMPTY_ICON_CLASSES = 'w-16 h-16 mx-auto text-gray-500 mb-4'
const EMPTY_TEXT_CLASSES = 'text-gray-500'
const EMPTY_SUBTITLE_CLASSES = 'text-sm text-gray-500 mt-2'
</script>