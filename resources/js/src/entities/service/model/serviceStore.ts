...
export const useServiceStore = defineStore('service', () => {
  ...
  const fetchItems = async () => {
    ...
    try {
      ...
      error.value = (err as Error).message || 'Ошибка загрузки'
  ...
  const fetchItem = async (_id: any) => {
    ...
    try {
      ...
      error.value = (err as Error).message || 'Ошибка загрузки' as any
  ...
  const createItem = async (_data: any) => {
    ...
    try {
      ...
      error.value = (err as Error).message || 'Ошибка создания' as any
  ...
  const updateItem = async (_id: any, _data: any) => {
    loading.value = true
    error.value = null
    ...
    try {
      ...
      error.value = (err as Error).message || 'Ошибка обновления' as any
  ...
  const deleteItem = async (id: any) => {
    ...
    try {
      ...
      error.value = (err as Error).message || 'Ошибка удаления' as any
