                ...
                <nav class="flex-1">
                    <div class="py-2">
                        ...
                        <div class="px-4 mt-2 space-y-1">
                            ...
                            <Link href="/settings" class="flex items-center px-3 py-2 text-sm bg-blue-50 text-blue-700 font-medium rounded-md transition-colors">Настройки</Link>
            ...
            <section class="flex-1">
                <ContentCard>
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 mb-3">Настройки</h3>
