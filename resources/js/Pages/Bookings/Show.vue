  ...
  <div class="py-6 lg:py-8">
    <div class="container mx-auto px-4 max-w-4xl">
      ...
      <nav class="mb-6 text-sm">
        ...
        <Link :href="route('bookings.index')" class="text-gray-500 hover:text-gray-500">
          Мои бронирования
        </Link>
        <span class="mx-2 text-gray-500">/</span>
        <span class="text-gray-500">№{{ booking.booking_number }}</span>
      </nav>
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-sm p-6 sticky top-4">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                <span class="text-gray-500">Статус оплаты:</span>
                <span
                  :class="[
                    'font-medium',
            ...
            <div
              v-if="booking.payment_status === 'pending' && booking.payment_method === 'online' && booking.status === 'confirmed'" 
              class="mt-4"
            >
            ...
            <div class="mt-6 pt-6 border-t text-center">
              ...
              <div class="inline-block p-4 bg-gray-500 rounded-lg">
                <div class="w-32 h-32 bg-gray-500 rounded flex items-center justify-center text-xs text-gray-500">
                  QR Code
                </div>
              </div>
    ...
    <Modal :show="showCancelModal" @close="showCancelModal = false">
      <div class="p-6">
        ...
        <div class="flex justify-end gap-3">
          <button 
            class="px-4 py-2 bg-gray-500 rounded-lg hover:bg-gray-500 transition"
