...
<template>
  <div class="adaptive-grid-example">
    <div class="container-adaptive">
      ...
      >
        ...
        >
          ...
          <div class="adaptive-card__content">
            <h3 class="adaptive-card__title">
              {{ item.title }}
            </h3>
            <p class="adaptive-card__description">
              {{ item.description }}
            </p>
      ...
      <section class="mt-16">
        <h2 class="heading-section">
          Компактная Сетка (как Wildberries)
        </h2>
