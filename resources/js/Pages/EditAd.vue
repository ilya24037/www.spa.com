  ...
  <div class="min-h-screen bg-gray-500">
    ...
    <div v-else class="max-w-4xl mx-auto py-6 lg:py-8">
      ...
      <nav class="flex items-center mb-6" aria-label="Breadcrumb">
        <button 
          class="flex items-center text-gray-500 hover:text-gray-500 transition-colors mr-4"
          @click="goBack"
        >
          <svg
            class="w-5 h-5 mr-1"
        ...
        <ol class="flex items-center space-x-2 text-sm">
          ...
          <li>
            <span class="text-gray-500 font-medium">Р РµРґР°РєС‚РёСЂРѕРІР°РЅРёРµ РѕР±СЉСЏРІР»РµРЅРёСЏ</span>
          </li>
        </ol>
      </nav>
      ...
      <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-500">
          <h1 class="text-2xl font-bold text-gray-500">
            Р РµРґР°РєС‚РёСЂРѕРІР°РЅРёРµ РѕР±СЉСЏРІР»РµРЅРёСЏ
          </h1>
