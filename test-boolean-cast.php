...
// Проверяем JSON encoding
$json = json_encode($array);
$decoded = json_decode($json, true);
echo "is_starting_price after JSON: " . ($decoded['is_starting_price'] ? 'true' : 'false') . "\n";
echo "Type: " . gettype($decoded['is_starting_price']) . "\n";
