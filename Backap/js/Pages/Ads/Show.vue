    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg p-6">
            ...
            <div class="prose max-w-none">
              <p class="text-gray-700 leading-relaxed whitespace-pre-line">{{ ad.description || 'Описание не указано' }}</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg p-6">
            ...
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <dd class="text-gray-900">{{ ad.experience || 'Не указан' }}</dd>
              </div>
              <div>
                <dt class="text-sm font-medium text-gray-500">Формат работы</dt>
                <dd class="text-gray-900">{{ ad.work_format || 'Не указан' }}</dd>
              </div>
              <div v-if="ad.clients && ad.clients.length > 0">
                <dt class="text-sm font-medium text-gray-500">Категории клиентов</dt>
                <dd class="text-gray-900">{{ ad.clients.join(', ') }}</dd>
              </div>
              <div v-if="ad.service_location && ad.service_location.length > 0">
                <dt class="text-sm font-medium text-gray-500">Места оказания услуг</dt>
        ...
        <div class="space-y-6">
          <!-- Цена -->
          <div class="bg-white rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-4">Стоимость</h2>
          ...
          <div class="bg-white rounded-lg p-6">
            ...
            <div class="space-y-3">
              ...
              <div v-if="ad.contact_method">
                <dt class="text-sm font-medium text-gray-500">Способ связи</dt>
          ...
          <div class="bg-white rounded-lg p-6">
            ...
            <dl class="space-y-2">
              ...
              <div class="flex justify-between">
                <dt class="text-gray-500">В избранном</dt>
                <dd class="text-gray-900">{{ ad.favorites_count || 0 }}</dd>
              </div>
              <div class="flex justify-between">
                <dt class="text-gray-500">Показы контактов</dt>
