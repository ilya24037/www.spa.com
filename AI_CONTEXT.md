...
Дата генерации: 17.06.2025 14:36:29
...
- 🧩 Компонент resources/js\Components\Layout\SidebarWrapper.vue (изменён в 14:26)
- 📄 Страница resources/js\Pages\Home.vue (изменён в 14:24)
- 🎨 Vue файл resources/js\Layouts\AppLayout.vue (изменён в 13:56)
- 📄 Страница resources/js\Pages\Home — копия.vue (изменён в 13:22)
- 📄 Страница resources/js\Pages\Masters\Show.vue (изменён в 13:17)
- 📄 Страница resources/js\Pages\Favorites\Index.vue (изменён в 13:14)
- 🎨 Vue файл resources/js\Layouts\AppLayout — копия.vue (изменён в 13:05)
- 🧩 Компонент resources/js\Components\Header\Navbar.vue (изменён в 12:05)
- 🧩 Компонент resources/js\Components\Cards\MasterCard.vue (изменён в 11:31)
...
- Cards: используется 9 раз
- Modal: используется 8 раз
- Map: используется 7 раз
...
*Этот контекст автоматически сгенерирован 17.06.2025 в 14:36*