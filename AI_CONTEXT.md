...
Дата генерации: 30.06.2025 02:28:15
...
- 🧩 Компонент resources/js\Components\Header\UserMenu.vue (изменён в 21:47)
- 🧩 Компонент resources/js\Components\Header\Navbar — копия.vue (изменён в 21:33)
...
*Этот контекст автоматически сгенерирован 30.06.2025 в 02:28*