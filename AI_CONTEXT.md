...
Дата генерации: 04.07.2025 14:22:51
...
- 📄 Страница resources/js\Pages\Masters\Show.vue (изменён в 14:11)
- 🧩 Компонент resources/js\Components\Masters\MasterPhotoGallery.vue (изменён в 14:06)
- 📄 Страница resources/js\Pages\Masters\Show — копия (3).vue (изменён в 14:04)
- 📄 Страница resources/js\Pages\Masters\прототип gptТекстовый документ.txt (изменён в 13:56)
- 🧩 Компонент resources/js\Components\Reviews\ReviewsList.vue (изменён в 13:53)
- 🧩 Компонент resources/js\Components\Common\StarRating.vue (изменён в 13:42)
- ⚡ JavaScript resources/js\utils\helpers.js (изменён в 13:41)
- 🧩 Компонент resources/js\Components\Common\ImageGalleryModal.vue (изменён в 13:38)
- 📄 Страница resources/js\Pages\Masters\Show — копия (2).vue (изменён в 16:08)
- 📄 Страница resources/js\Pages\Masters\Show — копия.vue (изменён в 15:20)
...
*Этот контекст автоматически сгенерирован 04.07.2025 в 14:22*