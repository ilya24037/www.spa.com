...
Дата генерации: 01.07.2025 08:43:39
...
- 🎮 Контроллер app\Http\Controllers\ProfileController.php (изменён в 08:33)
- 🗄️ Миграция database\migrations\2025_07_01_081421_create_favorites_table.php (изменён в 08:16)
- 📋 Модель app\Models\User.php (изменён в 08:13)
- ⚡ JavaScript resources/js\app.js (изменён в 08:01)
- 🧩 Компонент resources/js\Components\Dashboard\EmptyState.vue (изменён в 07:59)
- 🧩 Компонент resources/js\Components\Dashboard\ProfileCard.vue (изменён в 07:58)
- 📄 Страница resources/js\Pages\Dashboard.vue (изменён в 07:57)
...
*Этот контекст автоматически сгенерирован 01.07.2025 в 08:43*