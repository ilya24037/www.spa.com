...
Дата генерации: 07.07.2025 10:59:14
...
- 🧩 Компонент resources/js\Components\Cards\MasterCard.vue (изменён в 10:25)
...
- 📄 Страница resources/js\Pages\Auth\Login.vue (изменён в 10:07)
- 📄 Страница resources/js\Pages\Auth\Register.vue (изменён в 10:07)
- 📄 Страница resources/js\Pages\Auth\ResetPassword.vue (изменён в 10:07)
- 📄 Страница resources/js\Pages\Auth\VerifyEmail.vue (изменён в 10:07)
- 📄 Страница resources/js\Pages\Bookings\NewBooking.vue (изменён в 09:59)

🎯 **Скорее всего работали над:** страницами и роутингом

**⚠️ Незакоммиченные изменения:** 33 файлов
...
*Этот контекст автоматически сгенерирован 07.07.2025 в 10:59*