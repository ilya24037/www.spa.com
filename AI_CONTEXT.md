...
Дата генерации: 04.07.2025 08:40:12
...
- 📄 Страница resources/js\Pages\Masters\Show.vue (изменён в 16:08)
- 📄 Страница resources/js\Pages\Masters\Show — копия.vue (изменён в 15:20)
- 🧩 Компонент resources/js\Components\MetaTags.vue (изменён в 15:10)
- 📋 Модель app\Models\MasterProfile.php (изменён в 14:30)
- 📋 Модель app\Models\WorkZone.php (изменён в 14:16)
- 🧩 Компонент resources/js\Components\Cards\MasterCard.vue (изменён в 14:00)
- 🎮 Контроллер app\Http\Controllers\MasterController.php (изменён в 13:46)
- 📁 Файл app\Console\Commands\GenerateMasterMetaTags.php (изменён в 12:54)
- 📁 Файл app\Console\Commands\RegenerateMasterSlugs.php (изменён в 12:37)
- 📋 Модель app\Models\MasterProfile — копия.php (изменён в 12:36)
...
*Этот контекст автоматически сгенерирован 04.07.2025 в 08:40*