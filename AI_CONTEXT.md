...
Дата генерации: 15.06.2025 21:45:51
...
- 📄 Страница resources/js\Pages\Home.vue (изменён в 21:07)
- 🧩 Компонент resources/js\Components\Common\MobileFilters.vue (изменён в 21:01)
- 🎮 Контроллер app\Http\Controllers\HomeController.php (изменён в 20:30)
- 🗄️ Миграция database\migrations\2025_06_15_164446_add_is_active_to_master_profiles_table.php (изменён в 16:45)
- 🎨 Vue файл resources/js\Layouts\AppLayout.vue (изменён в 16:35)
- 🎮 Контроллер app\Http\Controllers\BookingController.php (изменён в 15:47)
- 📄 Страница resources/js\Pages\Bookings\Show.vue (изменён в 15:36)
- 📄 Страница resources/js\Pages\Bookings\Create.vue (изменён в 15:34)
- 📄 Страница resources/js\Pages\Bookings\Index.vue (изменён в 15:31)
- 🎮 Контроллер app\Http\Controllers\ProfileController.php (изменён в 15:26)

🎯 **Скорее всего работали над:** страницами и роутингом

**⚠️ Незакоммиченные изменения:** 30 файлов
...
*Этот контекст автоматически сгенерирован 15.06.2025 в 21:45*