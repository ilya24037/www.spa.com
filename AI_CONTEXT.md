...
Дата генерации: 28.06.2025 21:18:51
...
- 🧩 Компонент resources/js\Components\Header\Navbar.vue (изменён в 21:12)
...
- 🧩 Компонент resources/js\Components\Header\Navbar — копия.vue (изменён в 19:57)
...
*Этот контекст автоматически сгенерирован 28.06.2025 в 21:18*