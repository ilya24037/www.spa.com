...
Дата генерации: 16.06.2025 18:03:34
...
- 📄 Страница resources/js\Pages\Home.vue (изменён в 18:03)
- 🧩 Компонент resources/js\Components\Filters\QuickTagsRow.vue (изменён в 18:01)
- 🧩 Компонент resources/js\Components\Common\Breadcrumbs.vue (изменён в 18:00)
- 🎨 Vue файл resources/js\Layouts\AppLayout.vue (изменён в 17:53)
- 📁 Файл database\seeders\MasterSeeder.php (изменён в 17:01)
- 📁 Файл database\seeders\DatabaseSeeder.php (изменён в 16:51)
- 📁 Файл database\seeders\MassageCategorySeeder.php (изменён в 16:51)
- 📄 Страница resources/js\Pages\Home — копия.vue (изменён в 16:24)
...
*Этот контекст автоматически сгенерирован 16.06.2025 в 18:03*