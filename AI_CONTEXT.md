...
Дата генерации: 17.06.2025 11:21:12
...
- 📄 Страница resources/js\Pages\Home.vue (изменён в 11:03)
- 🧩 Компонент resources/js\Components\Cards\ListCard.vue (изменён в 10:56)
- 🧩 Компонент resources/js\Components\Map\MapMarker.vue (изменён в 10:43)
- 🧩 Компонент resources/js\Components\Filters\ServiceFilter.vue (изменён в 10:42)
- 🧩 Компонент resources/js\Components\Filters\FiltersSidebar.vue (изменён в 10:41)
- 🧩 Компонент resources/js\Components\Cards\MasterCard.vue (изменён в 10:41)
- 🧩 Компонент resources/js\Components\Cards\MasterCardList.vue (изменён в 08:35)
- 🧩 Компонент resources/js\Components\Cards\Cards.vue (изменён в 08:34)
- 🧩 Компонент resources/js\Components\Map\SimpleMap.vue (изменён в 08:33)
- 🧩 Компонент resources/js\Components\Filters\QuickTagsRow.vue (изменён в 07:48)

🎯 **Скорее всего работали над:** Vue компонентами и UI

**⚠️ Незакоммиченные изменения:** 22 файлов
...
- Card: используется 14 раз
- Modal: используется 8 раз
- Cards: используется 7 раз
- Filters: используется 6 раз
- Map: используется 6 раз

**⚠️ Неиспользуемые компоненты:** 23 (BookingModal — копия, ListCard, ApplicationLogo)

## 📈 МЕТРИКИ КАЧЕСТВА КОДА
**Анализ кодовой базы:**
- Средняя длина файла: 172 строк
- Самый большой файл: Service.php (293 строк)
- Дублирование кода: ⚠️ 15%
...
*Этот контекст автоматически сгенерирован 17.06.2025 в 11:21*