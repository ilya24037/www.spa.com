...
class MasterProfileResource extends Resource
{
    ...
    protected static string|null $navigationLabel = 'Мастера';

    protected static string|null $modelLabel = 'Мастер';

    protected static string|null $pluralModelLabel = 'Мастера';
    ...
    {
        return [
            MasterStatus::DRAFT->value => 'gray',
            MasterStatus::PENDING->value => 'warning',
            MasterStatus::ACTIVE->value => 'success',
            MasterStatus::INACTIVE->value => 'secondary',
            MasterStatus::BLOCKED->value => 'danger',
            MasterStatus::SUSPENDED->value => 'primary',
            MasterStatus::VACATION->value => 'info',
            MasterStatus::ARCHIVED->value => 'dark',
        ];
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\BadgeColumn::make('status')
                    ...
                    ->formatStateUsing(fn ($state): string => self::getStatusOptions()[$state] ?? $state),
            ...
            ->actions([
                ...
                Action::make('approve')
                    ...
                    ->action(function (MasterProfile $record): void {
                        app(MasterModerationService::class)->approve($record);
    ...
    {
        return Gate::allows('viewAny', MasterProfile::class);
    }

    public static function canCreate(): bool
    {
        return Gate::allows('create', MasterProfile::class);
    }
