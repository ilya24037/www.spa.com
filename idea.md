...
- **Главная панель** - общая статистика платформы, ключевые метрики
- **Управление пользователями** - все клиенты и мастера, блокировка, разблокировка
- **Управление объявлениями** - все объявления, модерация, удаление
- **Финансы** - все платежи, комиссии, вывод средств, отчеты
- **Модерация контента** - проверка объявлений, жалобы, нарушения
- **Аналитика** - детальная статистика, отчеты, тренды
- **Настройки системы** - конфигурация платформы, тарифы, лимиты
- **Управление модераторами** - создание, редактирование, права доступа
- **Поддержка** - тикеты, обращения пользователей
- **Логи и аудит** - все действия пользователей и системы

#### Для модераторов (разные уровни прав):
- **Модератор контента** - проверка объявлений, жалобы, нарушения
- **Модератор пользователей** - блокировка пользователей, проверка документов
- **Модератор финансов** - проверка платежей, вывод средств
- **Модератор поддержки** - ответы на обращения, тикеты
...
- **Административная панель** - полный контроль над платформой
...
- **Административная панель** - полный контроль и управление платформой
- **Система ролей и прав** - Spatie Laravel Permission для гибкого управления
