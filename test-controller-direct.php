...
echo "🎯 ТЕСТ КОНТРОЛЛЕРА DraftController::store НАПРЯМУЮ\n";
echo "=================================================\n\n";
...
try {
    ...
    // Симулируем данные как они приходят из формы (JSON поля как строки)
    $requestData = [
        'status' => 'draft',
        'specialty' => 'массаж',
        ...
        // JSON поля как строки (как из FormData)
        'prices' => '[]',
    ...
    if ($e->getPrevious()) {
        echo "\nПредыдущая ошибка: " . $e->getPrevious()->getMessage() . "\n";
    }
}
