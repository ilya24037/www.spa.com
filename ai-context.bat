...
echo [6] 📋 Показать контекст в консоли
echo [0] ❌ Выход
echo.

set /p choice="Выберите (0-6): "
...
if "%choice%"=="6" goto show_context
if "%choice%"=="0" exit
goto menu

:quick_context
cls
echo 📝 Генерирую быстрый контекст...
echo.
...
if exist AI_CONTEXT.md (
    ...
    echo ❌ Файл не найден. Сначала создайте контекст
)
echo ================================================
echo.
pause
