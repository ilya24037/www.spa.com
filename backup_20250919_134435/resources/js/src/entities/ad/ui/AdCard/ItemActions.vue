<template>
  <div class="item-actions" @click.stop>
    ...
    <div class="actions-container">
      ...
      <button class="main-action-button" @click="handleMainAction">
        {{ mainActionText }}
      </button>
      ...
      <ItemActionsDropdown 
        ...
        :show-pay="item.status === 'waiting_payment'"
        :show-promote="item.status === 'active'"
        :show-edit="true"
        :show-restore="item.status === 'archived'"
        :show-deactivate="['waiting_payment', 'active'].includes(item.status)"
        :show-delete="true"
...
.main-action-button {
  @apply px-4 py-2 bg-gray-500 text-gray-500 hover:bg-gray-500 rounded-lg transition-colors text-sm font-medium;
}
