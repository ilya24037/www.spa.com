  ...
  <div :class="CONTAINER_CLASSES">
    ...
    <div v-if="hasSchedule" :class="SCHEDULE_CLASSES">
      ...
      <div v-if="master.schedule_notes" :class="SCHEDULE_NOTES_CLASSES">
        <p :class="NOTES_TEXT_CLASSES">
          {{ master.schedule_notes }}
        </p>
      </div>
    </div>
  </div>
...
const CONTACT_ITEM_CLASSES = 'flex items-center justify-between p-4 border border-gray-500 rounded-lg'
const CONTACT_INFO_CLASSES = 'flex items-center gap-3'
const CONTACT_ICON_CLASSES = 'w-5 h-5 text-gray-500 flex-shrink-0'
const CONTACT_LABEL_CLASSES = 'text-sm text-gray-500'
const CONTACT_VALUE_CLASSES = 'font-medium text-gray-500'
...
const SCHEDULE_TITLE_CLASSES = 'font-medium text-gray-500'
const SCHEDULE_LIST_CLASSES = 'space-y-2'
const SCHEDULE_ITEM_CLASSES = 'flex items-center justify-between py-2 border-b border-gray-500 last:border-b-0'
const SCHEDULE_DAY_CLASSES = 'text-sm text-gray-500'
const SCHEDULE_HOURS_CLASSES = 'text-sm font-medium text-gray-500'
const SCHEDULE_NOTES_CLASSES = 'mt-3 p-3 bg-gray-500 rounded-lg'
const NOTES_TEXT_CLASSES = 'text-sm text-gray-500'
