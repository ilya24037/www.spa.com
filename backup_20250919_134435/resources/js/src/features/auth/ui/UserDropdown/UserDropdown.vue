...
<template>
  <div ref="dropdownRef" class="relative">
    ...
    >
      ...
      <span class="hidden lg:block ml-2 text-sm font-medium text-gray-500 max-w-32 truncate">
        {{ user.name }}
      </span>
      ...
      >
        ...
        <div class="py-1">
          ...
          >
            <component
              :is="item.icon"
              class="w-5 h-5 text-gray-500 group-hover:text-gray-500"
              aria-hidden="true"
            />
        ...
        <!-- Р‘Р°Р»Р°РЅСЃ -->
        <div v-if="showBalance" class="px-4 py-3 border-t border-gray-500">
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-500">Р‘Р°Р»Р°РЅСЃ</span>
        ...
        <div v-if="showProfileSwitcher && user.role === 'master'" class="px-4 py-3 border-t border-gray-500">
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-500">Р РµР¶РёРј РїСЂРѕСЃРјРѕС‚СЂР°</span>
            <button
            ...
            >
              ...
              <span :class="profileSwitchIndicatorClasses" />
            </button>
          </div>
        ...
        <div class="border-t border-gray-500 py-1">
          ...
          >
            <svg
              v-if="!isLoggingOut"
              class="w-5 h-5 text-gray-500 group-hover:text-red-500"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              aria-hidden="true"
            ...
            <div v-else class="w-5 h-5 border-2 border-gray-500 border-t-transparent rounded-full animate-spin" />
...
const userButtonClasses = computed(() => [
    ...
    'hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2',
    'max-w-xs'
])
...
const menuItemClasses = computed(() => [
    'flex items-center w-full px-4 py-2 text-sm text-gray-500 transition-colors duration-150',
    'hover:bg-gray-500 group'
])
...
const onlineStatusClasses = computed(() => [
    'absolute -bottom-0 -right-0 block h-2.5 w-2.5 rounded-full ring-2 ring-white',
    {
        ...
        'bg-gray-500': !props.user.isOnline
    }
])
...
const profileSwitchClasses = computed(() => [
    ...
    'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2',
    {
        ...
        'bg-gray-500': profileMode.value === 'user'
    }
])
