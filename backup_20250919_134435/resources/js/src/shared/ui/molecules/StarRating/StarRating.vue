  ...
  <div class="flex items-center">
    <div class="flex">
      <span
        ...
        class="star"
        :class="[
          star <= fullStars ? 'text-yellow-400' : 'text-gray-500',
          sizeClasses[size]
        ]"
      >
        <svg
        ...
        >
          <defs>
            <linearGradient :id="`half-${componentId}`">
              ...
              <stop offset="50%" stop-color="currentColor" class="text-gray-500" />
            </linearGradient>
          </defs>
          <path 
    ...
    <span v-if="showValue" class="ml-1 text-gray-500" :class="sizeClasses[size]">
      {{ rating.toFixed(1) }}
    </span>
  </div>
</template>
